...
A Quiz/Exam app built in Django 1.8
...
.. code-block:: bash
    ...
    cd easypmp-django
    celery -A easypmp-django.taskapp worker -l info
...
To run the tests, enter the easypmp-django/tests directory and run the following commands::
