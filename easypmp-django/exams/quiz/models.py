...
class KnowledgeAreaManager(models.Manager):
    ...
    def new_knowledge_area(self, knowledge_area):
        new_knowledge_area = self.create(knowledge_area=re.sub('\s+', '-', knowledge_area)
                                   .lower())

        new_knowledge_area.save()
        return new_knowledge_area


class ProcessGroupManager(models.Manager):

    def new_process_group(self, process_group):
        new_knowledge_area = self.create(process_group=re.sub('\s+', '-', process_group)
                                   .lower())

        new_process_group.save()
        return new_process_group


class ProficiencyLevelManager(models.Manager):

    def new_proficiency_level(self, proficiency_level):
        new_proficiency_level = self.create(proficiency_level=re.sub('\s+', '-', proficiency_level)
                                   .lower())

        new_proficiency_level.save()
...
class KnowledgeArea(models.Model):
    ...
    description = models.TextField(
        ...
        blank=True, help_text=_("a description of the knowledge area"))
...
class ProficiencyLevel(models.Model):
    ...
    description = models.TextField(
        verbose_name=_("Description"),
        blank=True, help_text=_("a description of the proficiency level"))

    objects = ProficiencyLevelManager()

    class Meta:
        verbose_name = _("Proficiency Level")
        verbose_name_plural = _("Proficiency Levels")
...
class Exam(models.Model):
    ...
    description = models.TextField(
        verbose_name=_("Description"),
        blank=True, help_text=_("a description of the assessment"))
    ...
    knowledge_area = models.ForeignKey(
        KnowledgeArea, null=False, blank=False,
        verbose_name=_("Knowledge Area"))

    process_group = models.ForeignKey(
        ProcessGroup, null=False, blank=False,
        verbose_name=_("Process Group"))

    proficiency_level = models.ForeignKey(
        ProficiencyLevel, null=False, blank=False,
        verbose_name=_("Proficiency Level"))
    ...
    answers_at_end = models.BooleanField(
        blank=False, default=False,
        help_text=_("Display answers ONLY at the end, not after question."),
    ...
    single_attempt = models.BooleanField(
        ...
        help_text=_("If yes, only one attempt by"
                    ...
                    " Non users cannot take this exam."),
    ...
    draft = models.BooleanField(
        ...
        help_text=_("If yes, the exam is not displayed"
                    " in the exam list and can only be"
    ...
    def save(self, force_insert=False, force_update=False, *args, **kwargs):
        ...
        super(Exam, self).save(force_insert, force_update, *args, **kwargs)
